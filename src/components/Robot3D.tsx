...
function RobotModel() {
  ...
  // We'll assume the user will upload it as 'robot_model.glb' in the public folder.
  // If it fails to load, we'll show the fallback.
      ...
      <div className="flex flex-col items-center gap-4 bg-black/80 p-6 rounded-lg border border-cyber-blue/30 backdrop-blur-md">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-[10px] font-mono text-gray-500 uppercase">
            Upload 'robot_model.glb' to public/
          </span>
        </div>
      </div>
    </Html>
